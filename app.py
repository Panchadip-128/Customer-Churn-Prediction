...
# Read the dataset
df_1 = pd.read_csv(r"C:\Users\User\PycharmProjects\churn_pred\first_telc.csv")
...
def predict():
    ...
    model = pickle.load(open(r"C:\Users\User\PycharmProjects\churn_pred\model.sav", "rb"))
...
if __name__ == "__main__":
    app.run(debug=True)  # Add any additional parameters you need
